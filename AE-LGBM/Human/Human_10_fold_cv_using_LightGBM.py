...
os.chdir(sys.path[1] + '\\Human\\cua_thnhan')

# load or create your dataset
# gbm_Human là đặc trưng đã qua AutoEncoder
...
part = np.repeat(list(range(0, 5)),
                 math.floor((data.shape[0] / 5)),
...
for k in range(5):
    ...
    # if k == 4:
    #     print("\nTham số của LightGBM:")
    #     pprint.pprint(lgb.get(deep=False), width=1, sort_dicts=False)
