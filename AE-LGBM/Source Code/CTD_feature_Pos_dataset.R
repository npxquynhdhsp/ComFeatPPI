...
pair.p <- read.csv(path1, stringsAsFactors = F)

MMI_class <- list(Hyd_Polar_1 <- list(
  c("R", "K", "E", "D", "Q", "N"), c("G", "A", "S", "T", "U", "X", "P", "H", "Y"), c("C", "L", "V", "I", "M", "F", "W"))
  , Hyd_Polar_2 <- list(c("Q", "S", "T", "U", "X", "N", "G", "D", "E"), c("R", "A", "H", "C", "K", "M", "V"), c("L", "Y", "P", "F", "I", "W"))
  , Hyd_Polar_3 <- list(c("Q", "N", "G", "S", "W", "T", "U", "X", "D", "E", "R", "A"), c("H", "M", "C", "K", "V"), c("L", "P", "F", "Y", "I"))
  , Hyd_Polar_4 <- list(c("K", "P", "D", "E", "S", "N", "Q", "T", "U", "X"), c("G", "R", "H", "A"), c("Y", "M", "F", "W", "L", "C", "V", "I"))
  , Hyd_Polar_5 <- list(c("K", "D", "E", "Q", "P", "S", "R", "N", "T", "U", "X", "G"), c("A", "H", "Y", "M", "L", "V"), c("F", "I", "W", "C"))
  , Hyd_Polar_6 <- list(c("R", "D", "K", "E", "N", "Q", "H", "Y", "P"), c("S", "G", "T", "U", "X", "A", "W"), c("C", "V", "L", "I", "M", "F"))
  , Hyd_Polar_7 <- list(c("K", "E", "R", "S", "Q", "D"), c("N", "T", "U", "X", "P", "G"), c("A", "Y", "H", "W", "V", "M", "F", "L", "I", "C"))
  , vanderWaals <- list(c("G", "A", "S", "T", "U", "X", "P", "D"), c("N", "V", "E", "Q", "I", "L", "C"), c("M", "H", "K", "F", "R", "Y", "W"))
  , Polarity_va <- list(c("L", "I", "F", "W", "C", "M", "V", "Y"), c("P", "A", "T", "U", "X", "G", "S"), c("H", "Q", "R", "K", "N", "E", "D"))
  , Polarizabil <- list(c("G", "A", "S", "D", "T", "U", "X"), c("C", "P", "N", "V", "E", "Q", "I", "L"), c("K", "M", "H", "F", "R", "Y", "W"))
  , Charge_sets <- list(c("K", "R"), c("A", "N", "C", "Q", "G", "H", "I", "L", "M", "F", "P", "S", "T", "U", "X", "W", "Y", "V"), c("D", "E"))
  , struc_Helix <- list(c("E", "A", "L", "M", "Q", "K", "R", "H"), c("V", "I", "Y", "C", "W", "F", "T", "U", "X"), c("G", "N", "P", "S", "D"))
  , Solv_Buried <- list(c("A", "L", "F", "C", "G", "I", "V", "W"), c("R", "K", "Q", "E", "N", "D"), c("M", "P", "S", "T", "U", "X", "H", "Y")))
...
write.csv(rbind(MMI.a.p), path2, row.names = F)
write.csv(rbind(MMI.b.p), path3, row.names = F)
