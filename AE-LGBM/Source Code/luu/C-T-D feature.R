...
write.csv(rbind(MMI.a.p, MMI.a.n), "../../Independent Species/Ecoli/MMI_a.csv", row.names = F)
write.csv(rbind(MMI.b.p, MMI.b.n), "../../Independent Species/Ecoli/MMI_b.csv", row.names = F)
