...
def eval_Testsets(trained_bilstm, trained_rf, dset_name):
    P_seq_A = get_protein_from_fasta('data/Testsets/' + dset_name + '/' + dset_name + '_proA.txt')
    P_seq_B = get_protein_from_fasta('data/Testsets/' + dset_name + '/' + dset_name + '_proB.txt')
    ...
    pickle.dump(prob_y, open('data/Testsets/' + dset_name + '_pred.pkl', 'wb'))
